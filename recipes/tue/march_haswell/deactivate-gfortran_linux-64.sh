...
if [ "${CONDA_BUILD}" = "1" ]; then
  FFLAGS_USED="-march=haswell -mtune=haswell -ftree-vectorize -fPIC -fno-plt -O3 -pipe -I${PREFIX}/include"
else
  FFLAGS_USED="-march=haswell -mtune=haswell -ftree-vectorize -fPIC -fno-plt -O3 -pipe"
fi
...
_tc_activation \
  ...
  "DEBUG_FFLAGS,${FFLAGS:-${FFLAGS_USED} -march=haswell -mtune=haswell -ftree-vectorize -fPIC -fno-plt -Og -g -Wall -Wextra -fcheck=all -fbacktrace -fimplicit-none -fvar-tracking-assignments -pipe}" \
  "DEBUG_FORTRANFLAGS,${FORTRANFLAGS:-${FFLAGS_USED} -march=haswell -mtune=haswell -ftree-vectorize -fPIC -fno-plt -Og -g -Wall -Wextra -fcheck=all -fbacktrace -fimplicit-none -fvar-tracking-assignments -pipe}" \
