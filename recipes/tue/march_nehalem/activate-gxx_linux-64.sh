...
if [ "${CONDA_BUILD}" = "1" ]; then
  CXXFLAGS_USED="-fvisibility-inlines-hidden -std=c++11 -fmessage-length=0 -march=nehalem -mtune=nehalem -ftree-vectorize -fPIC -fno-plt -O3 -pipe -I${PREFIX}/include"
  DEBUG_CXXFLAGS_USED="-fvisibility-inlines-hidden -std=c++11 -fmessage-length=0 -march=nehalem -mtune=nehalem -ftree-vectorize -fPIC -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe -I${PREFIX}/include"
else
  CXXFLAGS_USED="-fvisibility-inlines-hidden -std=c++11 -fmessage-length=0 -march=nehalem -mtune=nehalem -ftree-vectorize -fPIC -fno-plt -O3 -pipe"
  DEBUG_CXXFLAGS_USED="-fvisibility-inlines-hidden -std=c++11 -fmessage-length=0 -march=nehalem -mtune=nehalem -ftree-vectorize -fPIC -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
fi
