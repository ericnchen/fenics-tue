...
if [ "${CONDA_BUILD}" = "1" ]; then
  CFLAGS_USED="-march=opteron -mtune=opteron -ftree-vectorize -fPIC -fno-plt -O3 -pipe -I${PREFIX}/include"
  DEBUG_CFLAGS_USED="-march=opteron -mtune=opteron -ftree-vectorize -fPIC -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe -I${PREFIX}/include"
  LDFLAGS_USED="-Wl,-O3 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,${PREFIX}/lib -L${PREFIX}/lib"
else
  CFLAGS_USED="-march=opteron -mtune=opteron -ftree-vectorize -fPIC -fno-plt -O3 -pipe"
  DEBUG_CFLAGS_USED="-march=opteron -mtune=opteron -ftree-vectorize -fPIC -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
